...
export default function Cart({cartOpen,cartCount,setCartOpen}) {
    ...
    return (
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50">
            <ul className="space-y-2 text-black h-full flex flex-col justify-start items-start">
                ...
                <hr/>
                {
                    carts.length > 0 && carts.map(cart=><CartCard key={cart.id} cart={cart} inc={incPrice} dec={decPrice}/>)
                }
